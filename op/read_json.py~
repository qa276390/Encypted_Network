...
if __name__ == "__main__":
    ...
    for i in range(1,len(data)):
        ...
        timewidth.append(data[i]['time_end']-data[i]['time_start'])
    ...
    plt.bar(time,pktout,timewidth,facecolor='#ff4500',edgecolor='#ff4500',label="bytes_out")
    plt.bar(time,pktin,timewidth,facecolor='green',edgecolor='green',label="bytes_in")
